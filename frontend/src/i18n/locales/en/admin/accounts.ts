    ...
    accounts: {
      ...
      openai: {
        ...
        chatCompletionsModeDesc:
          'Only applies to OpenAI API Key accounts. When enabled, the account uses the Chat Completions transport for text requests instead of the Responses transport.',
