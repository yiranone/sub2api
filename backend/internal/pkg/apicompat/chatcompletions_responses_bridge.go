...
// responsesToChatCompletionsRequestBridge converts a Responses API request into a
// Chat Completions request for upstreams that only implement
// /v1/chat/completions.
func responsesToChatCompletionsRequestBridge(req *ResponsesRequest) (*ChatCompletionsRequest, error) {
	if req == nil {
