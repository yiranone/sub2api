...
func TestChatCompletionsChunkToResponsesEvents_CustomToolCallStream(t *testing.T) {
	...
	events := ChatCompletionsBridgeChunkToResponsesEvents(chunk, state)
	events = append(events, FinalizeChatCompletionsBridgeResponsesStream(state)...)
...
func TestChatCompletionsChunkToResponsesEvents_CustomToolNameArrivesLate(t *testing.T) {
	...
	events = append(events, ChatCompletionsBridgeChunkToResponsesEvents(chunk1, state)...)
	events = append(events, ChatCompletionsBridgeChunkToResponsesEvents(chunk2, state)...)
	events = append(events, FinalizeChatCompletionsBridgeResponsesStream(state)...)
